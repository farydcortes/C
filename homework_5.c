...
#define COLUMNAS 10		//definimos la cantidad de columnas para el tablero
#define FILAS 10		//definimos la cantidad de filas para el tablero
#define ESPACIO_SIN_DESCUBRIR '.'
#define ESPACIO_DESCUBIERTO ' '
#define MINA '*'
#define CANTIDAD_MINAS \
  10  // ¿cuántas minas colocar en el tablero de manera aleatoria? 
#define DEBUG 0  // Si se pone en 1, se van a desocultar las minas
